...
from museek.factory.data_element_factory import DataElementFactory, ScanDataElementFactory
...
class TestScanDataElementFactory(unittest.TestCase):
    ...
    def test_create(self, mock_data_element):
        ...
        factory = ScanDataElementFactory(scan_dumps=mock_scan_dumps).create(array=mock_array)
        self.assertEqual(factory, mock_data_element.return_value)
