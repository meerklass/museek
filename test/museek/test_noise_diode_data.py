...
class TestNoiseDiodeData(unittest.TestCase):
    ...
    def test_init(
        ...
        mock_noise_diode.assert_called_once_with(
            dump_period=mock_get_data.return_value.dump_period,
    ...
    def test_dumps(
        ...
        noise_diode_data = NoiseDiodeData(
            block_name="block_name",
            receivers=MagicMock(),
            token=None,
            scan_state=ScanStateEnum.SCAN,
        ...
        mock_noise_diode.return_value.get_noise_diode_off_scan_dumps.return_value = (
            mock_noise_diode_off_scan_dumps
        )
    ...
    def test_dumps_when_not_scan(
        ...
        self.assertEqual(
            mock_dumps_of_scan_state.return_value, noise_diode_data._dumps()
        )
        mock_set_data_elements.assert_called_once()
        mock_correlator_products_indices.assert_called_once()
        mock_get_data.assert_called_once()
