...
class TestContextLoader(unittest.TestCase):
    ...
    def test_requirements_dict(self, mock_pickle, mock_open):
        ...
        self.assertEqual(requirements_dict[mock_plugin.requirements[0].variable], expect)
        self.assertEqual(requirements_dict[mock_plugin.requirements[1].variable], expect)
