...
class TestReportWriter(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.report_writer = ReportWriter(output_path=self.output_path,
    ...
    def test_write_plot_description_to_report(self, mock_write_to_report):
        self.report_writer.write_plot_description_to_report(description='mock_description', plot_name='mock_plot_name')
        mock_write_to_report.assert_called_once_with(lines=['### mock_description', '![info](mock_plot_name)'])
    ...
    def test_write_header(self, mock_open):
        self.report_writer._write_header(data_name=self.data_name, plugin_name=self.plugin_name)
