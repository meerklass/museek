...
def flux_HerculesA(freq_Hz):
    ...
    F1410 = 47  # Jy
    F408 = 169  # Jy
    alpha = -np.log10(F1410 / F408) / np.log10(1410 / 408.0)
...
def flux_CenA(freq_Hz):
    ...
    F408 = 2746  # Jy
    alpha = -np.log10(F1400 / F408) / np.log10(1400 / 408.0)
...
def flux_1934_inter(freq_list_GHz):
    ...
    a0, a1, a2, a3 = (
        ...
        -7.0977,
        0.605334,
    )  # Lband-flux-calibrators.csv, katcofig
...
def flux_1934_sd(freq_list_GHz):
    # PKS
    PKS_freq_GHz = [0.408, 1.410, 2.700, 5.000, 8.400]
...
def get_point_source_model(calibrator_name, freq_Hz):
    ...
    if calibrator_name not in models:
        raise ValueError(
            f"Unknown calibrator: {calibrator_name}. "
