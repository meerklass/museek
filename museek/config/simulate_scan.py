...
InPlugin = ConfigSection(
    ...
    receiver_list=['m001h', 'm001v', 'm007h', 'm007v', 'm014h', 'm014v', 'm021h', 'm021v', 'm028h', 'm028v'],
    token=None,
...
ReadCalibratorGainsPlugin = ConfigSection(
    model_components_files=['/home/mgrsantos/projects/data/context/1675021905/model_components.pkl'],
    periods=None,
    verbose=0,
)
...
SimulateScanPlugin = ConfigSection(
    ...
    hi_gaussian_params={'alpha': -1.0, 'beta': 1.0, 'xi': 0.01, 'seed': 0},  # "vaguely cosmological"
