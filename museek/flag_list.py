...
class FlagList:
    ...
    @classmethod
    def from_array(cls, array: np.ndarray, element_factory: AbstractDataElementFactory) -> 'FlagList':
        """
    ...
    def add_flag(self, flag: Union[DataElement, 'FlagList']):
    ...
    def get(self, **kwargs) -> 'FlagList':
        """ Wraps `DataElement.get()` around each flag in `self` and returns a new `FlagList`. """
