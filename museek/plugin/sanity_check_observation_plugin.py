...
class SanityCheckObservationPlugin(AbstractPlugin):
    ...
    def run(
        ...
        # start
        logger.info("Starting the report")
    ...
    def save_output(
        ...
        logger.info("Loading visibility flags weights")
