...
class FlagFactory:
    ...
    def point_sources_coordinate_list(point_source_file_path: str) -> list[SkyCoord]:
        ...
        result = [
            SkyCoord(*(point_source * units.deg), frame="icrs")
            for point_source in point_sources
        ]
        return result

    def get_point_source_mask(
        self,
        ...
        mask_points = FlagFactory.point_sources_coordinate_list(
            point_source_file_path=point_source_file_path
        )
    ...
    def _coordinates_mask_dumps(
        ...
        """
        result = []
        data_points = SkyCoord(
            right_ascension.squeeze * units.deg,
            declination.squeeze * units.deg,
            frame="icrs",
        )
